...
namespace Zealand_Zoo_1FProjekt1semester2024.Services
{
    public class EventCatalog : IEventRepository
    {
        ...
        public EventCatalog()
        {
            ...
            events.Add(2, new Event() { Id = 2, Name = "Nat Bowling", Description = "yay", Limit = 25, OpeningTime = new DateTime(2024, 5, 15, 22, 0, 0), ClosingTime = new DateTime(2024, 5, 16, 01, 0, 0), ImageName = "Bowling.jfif" });
